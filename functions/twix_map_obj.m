...
properties(GetAccess='public', SetAccess='public') % Paul 2018.03.26 Change read-only properties to public
% properties(Dependent=true) 
...
methods (Access='protected')
    ...
    function [ixToRaw, ixToTarget] = calcIndices(this)
        % calculate indices to target & source(raw)
         LinIx     = this.Lin - this.skipLin; % original
         ParIx     = this.Par - this.skipPar; % original
